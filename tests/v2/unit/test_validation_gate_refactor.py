...
class TestValidateWithSchema:
    ...
    def test_works_with_annotation_schema(self) -> None:
        ...
        result = _validate_with_schema(df, AnnotationQualitySchema, "annotation_quality")
        assert result.passed is True
...
class TestExistingGatesStillWork:
    ...
    def test_validate_training_metrics_passes(self, valid_metrics_df: pd.DataFrame) -> None:
    ...
    def test_validate_training_metrics_fails(self, valid_metrics_df: pd.DataFrame) -> None:
