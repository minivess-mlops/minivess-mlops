...
| **Region** | `us-central1` (Iowa) | `.env.example` line 396 |
...
3. GPU quota: `GPUS_ALL_REGIONS >= 1` in `us-central1`
...
- Docker: `us-central1-docker.pkg.dev/minivess-mlops/minivess/base:latest`
