...
## When to Use
A new technology or architecture decision needs to be captured in the SDD.
...
4. Add archetype weights for each archetype defined in `archetypes/`
